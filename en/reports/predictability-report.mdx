...
![Image of Predictability Chart](/docs/images/predictability.png)
...
4. **Filtering Mode**: Select filtering mode (Activity/Completion).
5. **Completion Columns**: Choose completion columns (for Completion mode).
