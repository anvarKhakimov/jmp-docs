...
Unlike other reports, the Throughput Chart always uses the "Columns" mode for task filtering. The user cannot change this mode but can configure which columns are considered completing through the Completion Columns selection.
