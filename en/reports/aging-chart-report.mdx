...
- **Reduce WIP limits** if many tasks are in red zones
- **Add resources** to columns with persistent problems
- **Change process** for columns where tasks regularly "age"

## How to Use the Chart in Work

### 1. Daily Standups

**Start meetings with Aging Chart:**

- Show tasks in red zones — discuss what to do
- Tasks above 85th line — who needs help?
- New tasks in yellow zones — monitor

It's recommended to use the aging chart as a foundation for daily conversations about what blocks the flow.
...
- **Cycle Time** — shows how long completed tasks usually take
- **Throughput** — how many tasks we complete, Aging Chart — are we taking too much work

### 4. Specific Actions

**What to do with red tasks:**

1. Click on dot → open tasks in Jira
2. Understand what blocks them
3. Assign someone responsible for unblocking
4. Set deadline for problem resolution

**Process improvement:**

- If problems repeat in one column — change process in that column
- If many red tasks — reduce WIP limits
...
Start simple: show the chart to your team, discuss red tasks at standups, make data-driven decisions. Gradually you'll learn to see problems before they become critical, and your customers will receive results faster and more predictably.
