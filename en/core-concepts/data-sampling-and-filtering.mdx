...
Determines how tasks are filtered. Two modes are available: "Activity" and "Columns". You can find a detailed description of these modes in the [Filtering Modes](/en/docs/core-concepts/filtering-modes) article.

### Completion Columns

This parameter is only active in "Columns" filtering mode. It allows you to specify which columns, when passed through, mark a task as completed.
...
5. Choose the appropriate filtering mode (Activity or Columns).
...
- Remember that choosing a filtering mode can significantly affect the analysis results. Make sure you understand the difference between "Activity" and "Columns" modes.
